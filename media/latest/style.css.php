...
.submit_send input#send_btn, .dn_submit input#submit_download {
  background: <?php echo $cfg['main_color'];?> none repeat scroll 0 0;
...
.submit_send input#send_btn:hover {
  background: #ffffff none repeat scroll 0 0;
  border: 1px solid <?php echo $cfg['main_color_light'];?>;
  cursor: pointer;
}
...
.color_wrapper > h1, .logo_container > h1, #tabs1-typekit > h2, #tabs1-shar > h2, h1.main_middle_headings, #tabs1-settings > h2 {
  color: <?php echo $cfg['main_color_light'];?>;
  font-family: <?php echo $typekit_normal;?>;
  font-size: 32px;
  font-weight: normal;

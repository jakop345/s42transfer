...
<div id="cancel_container" class="cancel_container">
    <div id="upload_cncl" class="upload_cncl">
	    ...
	    <span class="cancel_txt">Page not Found!</span>
	    ...
	    <span class="cancel_txt_below"><a href="<?php echo $cfg['web_root'];?>" style="text-decoration:underline"> Go to s42.transfer's Home page  </a></span>
